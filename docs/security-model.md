...
| 14  | **Callback endpoint abuse**            | Flood of callback requests                                                                                            | Redis-backed application rate limit of 10 requests per client IP per minute on `/oauth/callback`; Redis TTL caps stored state volume                                                                       |
