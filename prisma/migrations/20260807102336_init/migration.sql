...
CREATE TABLE "verification_rules" (
    "id" TEXT NOT NULL,
    "guild_id" TEXT NOT NULL,
    "kind" "VerificationRuleKind" NOT NULL,
    "org" TEXT NOT NULL,
    "repo" TEXT,
    "team_slug" TEXT,
    "role_id" TEXT NOT NULL,
    "recheck_minutes" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "role_grants" ADD CONSTRAINT "role_grants_rule_id_fkey" FOREIGN KEY ("rule_id") REFERENCES "verification_rules"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
