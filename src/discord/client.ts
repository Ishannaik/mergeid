...
export async function startBot(options: {
  ...
  const { config, logger, oauthState, links, linkedRoles, rules, engine } = options;
  ...
  registerInteractionHandler(client, { config, logger: log, oauthState, links, linkedRoles, rules, engine });
